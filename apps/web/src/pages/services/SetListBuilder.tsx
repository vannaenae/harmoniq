...
import { getService, getSetList, saveSetList } from '@harmoniq/shared'
import { subscribeSongs } from '@harmoniq/shared'
import { generateId } from '@harmoniq/shared'
import { SuggestionsRail } from '@/components/suggestions/SuggestionsRail'
import type { SetListItem, Service, Song } from '@harmoniq/shared'
...
export function SetListBuilder() {
  ...
  const handleSave = async (publish: boolean) => {
    ...
    try {
      ...
      if (publish) {
        const { updateService } = await import('@harmoniq/shared')
        ...
        const { broadcastNotification } = await import('@harmoniq/shared')
