        ...
        <div className="w-full bg-white rounded-card-lg p-6 shadow-card flex flex-col gap-5">
          {sent ? (
            <div className="flex flex-col items-center text-center gap-4 py-4">
              ...
              <Link
                to="/sign-in"
                className="inline-flex items-center justify-center gap-2 rounded-pill font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-harmonic-primary active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:pointer-events-none min-h-[44px] bg-harmonic-primary text-white hover:opacity-90 px-6 py-2.5 text-sm w-full"
              >
                Back to sign in
              </Link>
            </div>
